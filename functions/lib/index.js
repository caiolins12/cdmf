...
exports.checkPendingPixPayments = exports.mercadoPagoWebhook = exports.checkPaymentStatus = exports.createPixPayment = void 0;
...
const mercadoPagoAccessToken = (0, params_1.defineSecret)("MERCADOPAGO_ACCESS_TOKEN");
// Obtém Access Token do secret
function getAccessToken() {
    const rawToken = mercadoPagoAccessToken.value();
    if (!rawToken) {
        throw new functions.https.HttpsError("failed-precondition", "Mercado Pago Access Token não configurado. Execute: firebase functions:secrets:set MERCADOPAGO_ACCESS_TOKEN");
    }
    ...
    if (!/^[\x20-\x7E]+$/.test(token)) {
        ...
        throw new functions.https.HttpsError("failed-precondition", "Access Token contém caracteres inválidos. Reconfigure o secret.");
    }
    return token;
}
/**
...
exports.createPixPayment = functions
    ...
    if (!invoiceId || !amount) {
        throw new functions.https.HttpsError("invalid-argument", "invoiceId e amount são obrigatórios");
    }
    if (!studentEmail) {
        throw new functions.https.HttpsError("invalid-argument", "Email do aluno é obrigatório para pagamento PIX");
    }
    try {
        ...
        const paymentData = {
            ...
            payer: {
                email: studentEmail,
                first_name: (studentName === null || studentName === void 0 ? void 0 : studentName.split(" ")[0]) || "Aluno",
                last_name: (studentName === null || studentName === void 0 ? void 0 : studentName.split(" ").slice(1).join(" ")) || "CDMF",
            },
        ...
        const response = await (0, node_fetch_1.default)(`${MP_API_URL}/v1/payments`, {
            method: "POST",
            headers: {
        ...
        if (!response.ok) {
            ...
            const errorMsg = result.message ||
                ((_b = (_a = result.cause) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.description) ||
                `HTTP ${response.status}`;
            throw new functions.https.HttpsError("internal", `Erro Mercado Pago: ${errorMsg}`);
        }
        ...
        if (result.status === "rejected") {
            ...
            const message = rejectionMessages[result.status_detail] ||
                `Pagamento rejeitado: ${result.status_detail}`;
            throw new functions.https.HttpsError("aborted", message);
        }
        // Extrai dados do PIX
        const pixData = (_c = result.point_of_interaction) === null || _c === void 0 ? void 0 : _c.transaction_data;
        if (!(pixData === null || pixData === void 0 ? void 0 : pixData.qr_code)) {
            throw new functions.https.HttpsError("internal", "PIX não disponível para este pagamento");
        }
        ...
        throw new functions.https.HttpsError("internal", error.message || "Erro ao criar pagamento");
    }
});
/**
...
exports.checkPaymentStatus = functions
    ...
    if (!paymentId && !invoiceId) {
        throw new functions.https.HttpsError("invalid-argument", "paymentId ou invoiceId é obrigatório");
    }
    try {
        const accessToken = getAccessToken();
        ...
        if (!mpPaymentId && invoiceId) {
            ...
            if (invoiceDoc.exists) {
                mpPaymentId = (_a = invoiceDoc.data()) === null || _a === void 0 ? void 0 : _a.mpPaymentId;
            }
        }
        if (!mpPaymentId) {
        ...
        const response = await (0, node_fetch_1.default)(`${MP_API_URL}/v1/payments/${mpPaymentId}`, {
            method: "GET",
            headers: {
                "Authorization": `Bearer ${accessToken}`,
            },
        ...
        if (isPaid && invoiceId) {
            ...
            if (invoiceDoc.exists && ((_b = invoiceDoc.data()) === null || _b === void 0 ? void 0 : _b.status) !== "paid") {
        ...
        throw new functions.https.HttpsError("internal", error.message || "Erro ao verificar pagamento");
    }
});
/**
...
exports.mercadoPagoWebhook = functions
    ...
    try {
        ...
        const paymentId = data === null || data === void 0 ? void 0 : data.id;
        if (!paymentId) {
        ...
        const response = await (0, node_fetch_1.default)(`${MP_API_URL}/v1/payments/${paymentId}`, {
            method: "GET",
            headers: {
                "Authorization": `Bearer ${accessToken}`,
            },
 ...
 */
exports.checkPendingPixPayments = functions
    .runWith({ secrets: [mercadoPagoAccessToken] })
    .pubsub
