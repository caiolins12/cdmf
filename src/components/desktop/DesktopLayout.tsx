...
const MasterFinanceScreen = lazy(() => import("../../screens/master/MasterFinanceScreen"));
const MasterEventsScreen = lazy(() => import("../../screens/master/MasterEventsScreen"));
const MasterCommunicationsScreen = lazy(() => import("../../screens/master/MasterCommunicationsScreen"));
const MasterSettingsScreen = lazy(() => import("../../screens/master/MasterSettingsScreen"));
...
const TAB_TITLES: Record<DesktopTab, { title: string; subtitle?: string }> = {
  ...
  eventos: { title: "Eventos", subtitle: "Workshops, Bailes e mais" },
  comunicacoes: { title: "Comunicações", subtitle: "WhatsApp e notificações" },
...
function DesktopLayoutContent({ userRole }: DesktopLayoutProps) {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case "financeiro":
        return <MasterFinanceScreen />;
      case "eventos":
        return <MasterEventsScreen />;
      case "comunicacoes":
        return <MasterCommunicationsScreen />;
      case "configuracoes":
