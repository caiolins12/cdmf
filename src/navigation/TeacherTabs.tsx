...
const TeacherHomeScreen = createLazyScreen(
  () => import("../screens/teacher/TeacherHomeScreen")
);
const TeacherClassesScreen = createLazyScreen(
  () => import("../screens/teacher/TeacherClassesScreen")
);
const TeacherStudentsScreen = createLazyScreen(
  () => import("../screens/teacher/TeacherStudentsScreen")
);
const TeacherAttendanceScreen = createLazyScreen(
  () => import("../screens/teacher/TeacherAttendanceScreen")
);
const TeacherReportsScreen = createLazyScreen(
  () => import("../screens/teacher/TeacherReportsScreen")
);
