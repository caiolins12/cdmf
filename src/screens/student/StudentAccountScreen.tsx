...
import { hasAcceptedAllLegalDocuments } from "../../legal/legalDocuments";
    ...
    return (
      <View style={[desktopStyles.screen, { backgroundColor: themeColors.bg }]}>
          ...
          <View style={[desktopStyles.dashboardContainer, { backgroundColor: themeColors.bg }]}>
            ...
            <View style={desktopStyles.actionsSection}>
              ...
              <View style={desktopStyles.actionsGrid}>
                ...
                <Pressable 
                  style={[desktopStyles.actionCard, { backgroundColor: themeColors.bgCard, borderColor: themeColors.border }]}
                  onPress={() => setShowPrivacyModal(true)}
                >
                  <View style={[desktopStyles.actionIconBox, { backgroundColor: isDark ? "#1E3A5F" : "#E0E7FF" }]}>
                    <Ionicons name="document-text" size={24} color="#4F46E5" />
                  </View>
                  <Text style={[desktopStyles.actionTitle, { color: themeColors.text }]}>
                    Política de Privacidade e Termos de Serviço
                  </Text>
                  <Text style={[desktopStyles.actionDescription, { color: themeColors.textMuted }]}>
                    Visualizar os dois documentos legais
                  </Text>
                </Pressable>
        ...
        <PrivacyPolicyModal
          ...
          onAccept={async () => {
            // Quando visualiza no perfil, não é obrigatório aceitar, apenas fecha
            setShowPrivacyModal(false);
          }}
          onClose={() => setShowPrivacyModal(false)}
          requireScroll={false}
          showCloseButton={true}
          alreadyAccepted={hasAcceptedAllLegalDocuments(profile)}
          viewOnly={true}
        />
      </View>
    );
    ...
    <View style={styles.screen}>
      ...
      >
        ...
        <View style={[styles.actionsRow, isDesktopMode && desktopStyles.actionsRow]}>
          ...
          <Pressable 
            style={[styles.actionBtn, isDesktopMode && desktopStyles.actionBtn]} 
            onPress={() => setShowPrivacyModal(true)}
          >
            <Ionicons name="document-text-outline" size={28} color="#111" />
            <Text style={styles.actionText}>Política de Privacidade{"\n"}e Termos de Serviço</Text>
          </Pressable>
        </View>
